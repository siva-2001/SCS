        ...
        "general_events":[
            {
                ...
                "pop_up_window_text" : "Вы уверены что хотите начать раунд?",
            },
            {
                ...
                "pop_up_window_text" : "Вы уверены что хотите продолжить раунд?",
            },
            {
                ...
                "pop_up_window_text" : "Вы уверены что хотите сменить стороны поля?",
            },
            {
                "signal":"STOP_MATCH",
                ...
                "pop_up_window_text" : "Вы уверены что хотите досрочно отменить матч? Это отменит его результаты",
            },
        ],
        "team_events":[
            {
            ...
            },
            {
                ...
                "description": "Останавливает счёт времени игрового раунда. Кнопка не должна быть активна одновременно с CONTINUE_ROUND кнопкой. Не должна быть активной когда translationDataMessage['data']['TEAMNUMBER_team']['pauseCount'] >= 2.  Должно иметь всплывающее окно подтверждения действия с указанием команды (помимо основого текста)",
                "pop_up_window_text" : "Вы уверены что хотите сделать паузу?",
            },
            {
                "signal": "CANCEL",
                ...
                "button_color": "CD6B67",
                "pop_up_window_text" : "Вы уверены что хотите отменить последнее очко?",
            },
        ]
    }
}