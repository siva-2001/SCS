$(document).ready(() => {
    ...
    function checkAccessPermissions(){
        $.ajax({
            ...
            success: function(data){
                ...
                if (data.isAnonymousUser){
                    ...
                    // убрать элементы профиля и создания нового сорева

                } else {
                    
                    // убрать кнопки авторизации и регистрации
        ...
        let login_button = $('[id="login-head-button"]');
...
// _______________________      ajax request functions       _____________________________
    ...
    // _______________________ШАПКА САЙТА_______________________________________
    ...
    if (window.location.pathname == '/'){
        $.ajax({
            method: "GET",
            url: "http://127.0.0.1:8000/api/v1/announcedEvents",
            dataType : 'json',
            headers:{ 
                "Authorization": cookieStrToObject(document.cookie).Authorization 
            },
