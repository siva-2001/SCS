...
#     #------------------------------------------------------------------------------------------------------------------
#     if competition._status == Competition.ANNOUNSED:
...
#                 competition._name=request.POST['name']
...
#                     competition.dateTimeStartCompetition = newCompDataTime
#                 competition.save()
#
#             # ----------------------------------------------------------------------------------------------------------
...
#                     if m == match:
#                         index = i
#                 match._name = request.POST['form-' + str(index) + '-name']
